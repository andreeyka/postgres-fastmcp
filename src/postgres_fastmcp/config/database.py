...
class DatabaseConfig(BaseModel):
    ...
    tool_prefix: str | None = Field(
        ...
        description=(
            ...
            "If specified, all tools receive this prefix (e.g., 'myprefix_list_objects'). "
            "Works in both HTTP and stdio modes. "
            "If not specified, single server uses no prefix; multiple servers use the server name."
        ),
    )
