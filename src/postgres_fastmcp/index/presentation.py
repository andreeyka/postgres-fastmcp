...
from postgres_fastmcp.common import calculate_improvement_multiple
...
from postgres_fastmcp.sql import IndexDefinition


if TYPE_CHECKING:
    from postgres_fastmcp.index.index_opt_base import IndexTuningBase
